...
interface ProductModalProps {
  ...
  onRequestClose: () => void;
  categories: Category[];
  onProductChange: (category: Product) => void;
  product?: Product;
  isEditing?: boolean;
}

export const ManageProductModal: React.FC<ProductModalProps> = (props) => {
  const {
    isOpen,
    onRequestClose,
    onProductChange,
  ...
  const handleWeightUnitChange = (
    ...
    const [currentWeight] = weight.split(" ");
  ...
  useEffect(() => {
    setCategoryId(isEditing && product ? product.category_id : null);
    setName(isEditing && product ? product.name : "");
    setBrand(isEditing && product ? product.brand : "");
    setWeight(isEditing && product ? product.weight : "");
    setPurchasePrice(isEditing && product ? product.purchase_price : null);
    setSalePrice(isEditing && product ? product.sale_price : null);
    setStock(isEditing && product ? product.stock : null);
  }, [isEditing, product]);
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="sm:items-start">
                    <div className="mt-3 text-center sm:mt-0 sm:text-left">
                      ...
                      >
                        {isEditing
                          ? `Editar producto ${product?.name} - ID#${product?.id}`
                          : "Crear producto"}
                      </h3>
